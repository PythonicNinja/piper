"""
Starter fabfile for deploying the piper project.
...
# CHANGEME
env.hosts = ['user@piper.example.com']
env.code_dir = '/srv/www/piper'
env.project_dir = '/srv/www/piper/piper'
env.static_root = '/srv/www/piper/static/'
env.virtualenv = '/srv/www/piper/.virtualenv'
env.code_repo = 'git@github.com:user/piper.git'
env.django_settings_module = 'piper.settings'
...
def restart():
    ...
    with cd(env.code_dir):
        run("touch %s/piper/wsgi.py" % env.code_dir)
